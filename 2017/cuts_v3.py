...
cuts['Mild_SR'] = 'Alt$(FatJet_msoftdrop[0],0.)>65 && Alt$(FatJet_msoftdrop[0],0.)<105 && mjj > 200 && detajj > 2.0 && Sum$(Jet_btagDeepB[CleanJet_jetIdx] > 0.1522) == 0 && mll>76 && mll<107'


cuts['Tight_SR'] = 'Alt$(FatJet_tau2[0]/FatJet_tau1[0],0.)<0.55 && Alt$(FatJet_msoftdrop[0],0.)>65 && Alt$(FatJet_msoftdrop[0],0.)<105 && mjj > 800 && detajj > 4.0 && Sum$(Jet_btagDeepB[CleanJet_jetIdx] > 0.1522) == 0 && mll>76 && mll<107'
 

"""
cuts['Top_CR'] = 'Alt$(FatJet_msoftdrop[0],0.)>65 && Alt$(FatJet_msoftdrop[0],0.)<105 && mjj > 800 && detajj > 4.0 && Sum$(Jet_btagDeepB[CleanJet_jetIdx] > 0.1522) >= 1 && mll>76 && mll<107 ' #SR cuts and bveto condition inverted
