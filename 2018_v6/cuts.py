...
#       '' : 'multiJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13)',
       '2j_btag' : 'nCleanFatJet==1 && Alt$(FatJet_mass[0],0.)>65 && Alt$(FatJet_mass[0],0.)<105 && bReq && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13)',
   }
}
...
#        '0j'     : 'zeroJet',
#        '1j'     : 'oneJet && Alt$(CleanJet_pt[1],0)<30',
        '2j_bveto'     : 'nCleanFatJet==1 && (Alt$(FatJet_mass[0],0.)<65 || Alt$(FatJet_mass[0],0.)>105) && bVeto && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11 || Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13)', 
