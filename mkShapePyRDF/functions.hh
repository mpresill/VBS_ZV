...
RVec<float> jets_cat(int nCleanJetNotFat,int  nCleanFatJet,RVec<float> & CleanJet_pt, RVec<int> & CleanJetNotFat_jetId, RVec<float> & CleanJet_phi, RVec<float> & CleanJet_eta, RVec<float> & Jet_mass, RVec<int> & CleanJet_jetId, RVec<float> & CleanFatJet_mass, int nLepton, RVec<float> & Lepton_eta, RVec<float> & CleanFatJet_eta, RVec<float> & Jet_qgl, RVec<int> & CleanFatJet_jetid){
...
RVec<float> cat{Mjj_max,detajj_mjj_max,dphijj_mjj_max,Vjet_mass_tmp, Zepp_ll, Zlep_1, Zlep_2, 999,999,999,999,999,999,999,999, category, Njet, Zfatjet, 999, 999,999,999,999,_nbtag};
