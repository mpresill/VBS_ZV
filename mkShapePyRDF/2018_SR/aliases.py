...
"""
aliases['cat']={
    'expr': "jets_cat(nCleanJetNotFat, nCleanFatJet, CleanJet_pt, CleanJetNotFat_jetIdx, CleanJet_phi, CleanJet_eta, Jet_mass, CleanJet_jetIdx, CleanFatJet_mass,nLepton, Lepton_eta)",
    }
