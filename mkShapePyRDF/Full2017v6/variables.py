...
variables['Lepton_eta'] = {   'name': 'TMath::Abs(Lepton_eta[0])',      
                        'range' : (30,0,2.5),  
                        'xaxis' : 'Lepton #eta', 
                        'fold' : 3
                        }

variables['Lepton_phi'] = {   'name': 'Lepton_phi[0]',      
                        }
...
variables['vbs_0_phi'] = {   'name': 'vbs_0_phi',      
                        }

variables['vbs_1_phi'] = {   'name': 'vbs_1_phi',      
                        }
...
variables['vjet_0_phi'] = {   'name': 'vjet_0_phi',      
                        }

variables['vjet_1_phi'] = {   'name': 'vjet_1_phi',      
                        }
