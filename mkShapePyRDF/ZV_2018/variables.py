...
variables['Zlep_1'] = {   'name': '( Lepton_eta[0]-0.5*(Alt(CleanJet_eta,vbs_jet_0,0)+Alt(CleanJet_eta,vbs_jet_1,0)))/detajj_mjjmax',      
                        'range' : (40,-1.5,1.5),  
                        'xaxis' : 'Z^{lep}_{l1}', 
                        'fold' : 3
                        }

variables['Zlep_2'] = {   'name': '( Lepton_eta[1]-0.5*(Alt(CleanJet_eta,vbs_jet_0,0)+Alt(CleanJet_eta,vbs_jet_1,0)) )/detajj_mjjmax',      
                        'range' : (40,-1.5,1.5),  
                        'xaxis' : 'Z^{lep}_{l2}', 
                        'fold' : 3
                        }
...
variables['vbs_jet_pt1']  = {   'name': 'Alt(CleanJet_pt,vbs_jet_0,-999)',
                        'range' : (20,0.,300),
                        'xaxis' : 'p_{T} 1st vbs jet [GeV]',
                        'fold' :3
                        }

variables['vbs_jet_pt2']  = {   'name': 'Alt(CleanJet_pt,vbs_jet_1,-999)',
                        'range' : (20,0.,300),
                        'xaxis' : 'p_{T} 2nd vbs jet [GeV]',
                        'fold' :3
                        }

variables['vbs_jet_eta1']  = {   'name': 'Alt(CleanJet_eta,vbs_jet_0,-999)',
                        'range' : (30,-3,3),
                        'xaxis' : '#eta 1st vbs jet [GeV]',
                        'fold' :3
                        }

variables['vbs_jet_eta2']  = {   'name': 'Alt(CleanJet_eta,vbs_jet_1,-999)',
                        'range' : (30,-3,3),
...
variables['V_jet_pt1']  = {   'name': 'Alt(CleanJet_pt,V_jet_0,-999)',
                        'range' : (20,0.,300),
                        'xaxis' : 'p_{T} 1st V jet [GeV]',
                        'fold' :3
                        }

variables['V_jet_pt2']  = {   'name': 'Alt(CleanJet_pt,V_jet_1,-999)',
                        'range' : (20,0.,300),
                        'xaxis' : 'p_{T} 2nd V jet [GeV]',
                        'fold' :3
                        }

variables['V_jet_eta1']  = {   'name': 'Alt(CleanJet_eta,V_jet_0,-999)',
                        'range' : (30,-3,3),
                        'xaxis' : '#eta 1st V jet [GeV]',
                        'fold' :3
                        }

variables['V_jet_eta2']  = {   'name': 'Alt(CleanJet_eta,V_jet_1,-999)',
                        'range' : (30,-3,3),
