...
mcSteps = 'MCl1loose2017v7__MCCorr2017v7__l2loose__l2tightOR2017v7'
...
samples['WW_ewk'] = {
    ...
    'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC + '*(Sum(AbsVec(GenPart_pdgId)==6 || GenPart_pdgId==25)==0)',  #filter tops and Higgs
    'FilesPerJob' : 2,
}            
